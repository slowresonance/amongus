...
// [/nogroup/feed] -> get_friends_feed -> an array of friend feeds
...
// the main advantage of this app especially when compared to something like split wise is
// that it includes powerful features like splitting with sets for complex splitting scenarios
...
// Frontend and Backend interact ONLY by whole, atomic "group" objects. No partial updates.
...
// /user
// getUser() a.k.a YOU the User(Mohan)
// postUser()

// Atomic user objects only. No partial updates.
